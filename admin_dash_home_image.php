      ...
      <nav class="nav2">
        <ul>
            <li class="dropdown">
              ...
              <ul>
                  <li><a href="admin_dash_home_image.php" style="color: rgba(0, 255, 0, 0.8)"><i class="fas fa-wrench"></i><span>Customized Home Image</span></a></li>
                    ...
                    <div class="widget-content nopadding table-responsive">
                        ...
                        <tbody>
                            ...
                            while($row=mysqli_fetch_array($res))
                            {
                                    ...
                                    echo "<td>"; ?> <a href="admin_edit_home_image.php?id=<?php echo $row["id"]; ?>"> <button type="button" class="btn btn-success">Edit</button></a> <?php echo "</td>";
...
if(isset($_POST["submit1"]))
{
    ...
    if($fnm1=="" || $fnm2=="" || $fnm3=="")
    {
      ...
      <?php
        ...
        setTimeout(function(){
            window.location.href=window.location.href;
            window.location="admin_dash_home_image.php";
        }, 3000);
        </script>
        <?php
    }
