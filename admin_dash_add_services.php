              ...
              <ul>
                  ...
                  <li class="dropdown_two split"><a href="#"><i class="fas fa-plus-square"></i><span>Set Program</span></a>
                      <ul>
                          ...
                          <li><a href="admin_dash_add_services.php" style="color: rgba(0, 255, 0, 0.8)"><i class="fas fa-plus-square"></i><span>Services</span></a>
                      </ul>
                  </li>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-12" style="margin: 10px 0 10px;">
                                            <div class="form-group" >
                                                <label for="last_name" style="font-weight: bold">Service:</label>
                                                    <input type="text" name="last_name" id="last_name" class="form-control input-lg" placeholder="Service">
                                                </div>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive">
                                ...
                                <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Services</th>
                                                <th>Change Services</th>
                                                <th>Remove Services</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                <tr>
                                                    <th scope="row">1</th>
                                                    <td>Soil Sampling</td>
                                                    <td><button id="declineB" type="button" class="btn btn-success" style="width: 100%">Change</button></td>
                                                    <td><button id="declineB" type="button" class="btn btn-danger" style="width: 100%">Remove</button></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">2</th>
